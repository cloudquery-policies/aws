policy "foundational_security" {
    ...
    policy "elb" {
        ...
        query "8" {
            ...
            query = file("queries/elbv1/https_predefined_policy.sql")
        }
    }
